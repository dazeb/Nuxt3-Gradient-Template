        ...
        <div class=" container mx-auto px-4 flex h-full py-6 items-center">
            <div class=" max-w-xl">
                ...
                <p class=" text-gray-500 mt-4 text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta error
                    odit vel minima optio consequuntur atque omnis, repellendus eos, rerum totam quas vitae voluptatibus,
                    facere distinctio fugit? Nam, iure expedita!</p>
            </div>
        </div>
    </header>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-4 py-10 lg:py-16 mx-auto lg:flex lg:items-center lg:justify-between">
            ...
            <div class="mt-8 lg:mt-0">
                ...
                <p class="mt-3 text-sm text-gray-500 dark:text-gray-300">Attention! Offer expires in 30 days. Make sure not

<template>
        ...
        <div class="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://dazeb.uk" class="flex items-center">
    ...
    <!-- <footer class="bg-white dark:bg-gray-900">
        <div class="container p-6 mx-auto">
                ...
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <a href="https://dazeb.uk" class="flex items-center">
                            <img src="@/assets/grad-logo.png" class="h-8 mr-3" alt="Gradient Logo" />
                            <span
                                class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Gradient</span>
                        </a>

                        <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">New Vue/Nuxt3 Components and templates
                            every week.</p>
            ...
            <div>
                <p class="text-center text-gray-500 dark:text-gray-400">© Gradient 2023 - All rights reserved</p>
            </div>
        </div>
    </footer> --></template>